var post = function (id, message, username, date, startLocation, endLocation) {
    this.id = id;
...
function loadPosts() {
    $.get('/api/posts', function (data) {
        ...
        $.each(data, function (i, p) {
            var newPost = new post(p.Id, p.Message, p.Username,p.startLocation,p.endLocation ,p.DatePosted);
...
$(function () {
    ...
    hub.client.receivedNewPost = function (id, username, message, startLocation, endLocation, date) {
        var newPost = new post(id, message, username, startLocation, endLocation, date);
